        ...
        <footer className={css.footer}>
            <div className={`container ${css.footerDiv}`}>
                <div className={css.mainDiv}>
                    ...
                    <div>
                        <p className={css.p}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae quo totam quos ad, maiores autem?</p>
                    </div>
                ...
                <div className={css.links}>
                    ...
                    <div className={css.secondColumnDiv}>
                        <p className={css.secondColumnP}>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quibusdam, nostrum.</p>
                    </div>
                </div>
            </div>
        </footer>
